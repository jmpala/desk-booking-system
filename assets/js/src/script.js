...
import './frontend/admin_users_list';
// - Unavailable Dates Section
import './frontend/admin_unavailabledates_list';
...
const newBookingPage = (function (): void {
  ...
  const {
    isAvailableAPIData,
    checkBookableAvailabilityBySelectedDatesRESTCall,
    setUnavailablePeriods
  } = require('./api/checkBookableAvailabilityBySelectedDatesRESTCall');
...
const editUnavailableDatePage = (function (): void {
  const {period, sanitizeDisplayDate, checkIfDatesAreValid, checkIfPeriodsOverlap} = require('./utils/dateUtils');
  const {
    checkUnavailableDatesAvailabilityAPIData,
    setUnavailablePeriods,
    checkUnavailableDatesAvailabilityAPIDataOptions,
    checkUnavailableDatesAvailabilityBySelectedDatesRESTCall
  } = require('./api/checkUnavailableDatesAvailabilityBySelectedDatesRESTCall');
